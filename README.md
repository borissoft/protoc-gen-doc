...
There is a Docker image available (`docker pull borissoft/protoc-gen-doc`) that has everything you need to generate
documentation from your protos.

If you'd like to install this locally, you can `go get` it.

`go install github.com/borissoft/protoc-gen-doc/cmd/protoc-gen-doc@latest`
...
docker run --rm \
  -v $(pwd)/examples/doc:/out \
  -v $(pwd)/examples/proto:/protos \
  borissoft/protoc-gen-doc --doc_opt=markdown,docs.md
```
...
docker run --rm \
  -v $(pwd)/examples/doc:/out \
  -v $(pwd)/examples/proto:/protos \
  borissoft/protoc-gen-doc --doc_opt=markdown,docs.md Booking.proto [OPTIONALLY LIST MORE FILES]
```
...
docker run --rm \
  -v $(pwd)/examples/doc:/out \
  -v $(pwd)/examples/proto:/protos \
  borissoft/protoc-gen-doc --doc_opt=:google/*,somepath/*
```
...
[custom]:
    https://github.com/borissoft/protoc-gen-doc/wiki/Custom-Templates
    "Custom templates instructions"
[html_preview]:
    https://rawgit.com/borissoft/protoc-gen-doc/master/examples/doc/example.html
    "HTML Example Output"
[codecov-svg]: https://codecov.io/gh/borissoft/protoc-gen-doc/branch/master/graph/badge.svg
[codecov-url]: https://codecov.io/gh/borissoft/protoc-gen-doc
[godoc-svg]: https://godoc.org/github.com/borissoft/protoc-gen-doc?status.svg
[godoc-url]: https://godoc.org/github.com/borissoft/protoc-gen-doc
[goreport-svg]: https://goreportcard.com/badge/github.com/borissoft/protoc-gen-doc
[goreport-url]: https://goreportcard.com/report/github.com/borissoft/protoc-gen-doc
[ci-svg]: https://github.com/borissoft/protoc-gen-doc/actions/workflows/ci.yaml/badge.svg?branch=master
[ci-url]: https://github.com/borissoft/protoc-gen-doc/actions/workflows/ci.yaml
[releases]: https://github.com/borissoft/protoc-gen-doc/releases
